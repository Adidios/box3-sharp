...
// @updateURL    https://greasyfork.org/scripts/456978-box3-sharp/code/box3-sharp.user.js
  ...
  function main() {
    ...
    if (GM_info.scriptWillUpdate) {
      addFunctionButton(
        ...
        async () => {
          GM_openInTab(
            GM_info.scriptUpdateURL || "https://greasyfork.org/zh-CN/scripts/456978-box3-sharp"
          );
        },
        "🎉更新到最新版本"
      );
